...
export const cpdcPermits = [
  {
    ...
    requirements:
      "A development project must align with the zoning ordinance and comprehensive land use plan (CLUP).",
  },
  {
    id: 2,
    icon: <MdClearAll />,
    ...
    requirements:
      "Ensures that a proposed project is situated in a legally designated area for its type (e.g., residential, commercial, or industrial).",
  },
  {
    id: 3,
    icon: <FaRegBuilding />,
    ...
    requirements:
      "It is a prerequisite to applying for a building permit from the local building office.",
  },
  {
    id: 4,
    icon: <CgPathDivide />,
    ...
    requirements:
      "The project must comply with density regulations, infrastructure standards, and environmental considerations.",
  },
  {
    id: 5,
    ...
    requirements:
      "Projects in certain zones (e.g., historic districts, eco-parks, etc.) may require additional scrutiny to ensure that they do not compromise heritage or the environment.",
  },
  {
    id: 6,
    icon: <LuTreePine />,
    ...
    requirements:
      "Projects that affect natural resources must go through the appropriate procedures to ensure environmental protection.",
  },
  {
    id: 7,
    ...
    requirements:
      "Completion of the development with adherence to approved plans and standards.",
  },
  {
    id: 8,
    icon: <FaSignOutAlt />,
    ...
    requirements:
      "Ensures that signage does not obstruct views or create hazards for drivers and pedestrians.",
  },
  {
    id: 9,
    ...
    requirements:
      "Typically used for special events (e.g., festivals, fairs) or short-term commercial activities.",
  },
  {
    id: 10,
    ...
    requirements:
      "A proposal for land use change must be justified and supported by updated planning documents.",
  },
  {
    id: 11,
    ...
    requirements:
      "Ensures that ongoing or completed projects are in line with regulatory requirements and standards.",
  },
  {
    id: 12,
    ...
    requirements:
      "Development proposals must address parking and traffic management to minimize adverse effects on local infrastructure.",
  },
  {
    id: 13,
    icon: <FaLaptopHouse />,
    ...
    requirements:
      "Must align with the local government's housing policies and resettlement programs.",
  },
  {
    id: 14,
    icon: <MdOutlineTour />,
    ...
    requirements:
      "Development must be aligned with sustainable tourism and infrastructure planning.",
  },
];

// The CPDO plays a key role in ensuring that development projects in a city or municipality follow proper urban planning guidelines, zoning regulations, and environmental laws. These permits ensure that growth is managed sustainably, safely, and in a manner that benefits the entire community.
